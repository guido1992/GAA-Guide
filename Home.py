...
def app():
    st.title('Home')
    st.write('Welcome to the GAA Analysis Guide')
    ...
    st.write("""
             ...
             ** *This application is still in development* **
             ...
             visualisation techniques, metrics and more into one document for easy access. It's 
             ultimate aim it be used as a teaching resource/tool to help improve both the
             ...
             A special shout out has to be given to Praneel Nihar, who's guide I used in
